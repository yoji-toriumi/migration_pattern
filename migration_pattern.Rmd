...
migration_flow$number <- migration_flow$t_2020 / 250000

key <- 'abc'    ## put your own token here
mapdeck(token = key)

migration_flow <- migration_point %>% 
  mutate(dots = log(t_2020 / 250000), radius = t_2020 / 25)
...
# migration_mapdeck <- 
  ...
  add_animated_line(
    ...
    add_scatterplot(lon = "ori_long", lat = "ori_lat", radius = "radius", layer_id = "scatter_layer", fill_colour = "#ffffff")
